...
ansible-pull -i localhost, -U https://github.com/Abhinav705/expense-ansible-roles-tf main.yaml -e component=$component -e env=$environment -e appVersion=$app_Version
